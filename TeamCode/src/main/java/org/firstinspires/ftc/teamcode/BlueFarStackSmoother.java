...
@Autonomous(name="Blue Far Stack SMOOTHER", preselectTeleOp = "1 Manual Control")
public class BlueFarStackSmoother extends LinearOpMode {
    UniversalControlClass control = new UniversalControlClass(true, false, this);
    MecanumDrive drive;
    Pose2d startPose;
    Pose2d deliverToFloorPose;
    Pose2d deliverToBoardPose;
    Pose2d stackPose = new Pose2d(-56, 11.5, Math.toRadians(180));
    ...
    public void BlueRightTeamArtPixelDelivery() {
        //***POSITION 1***
        if (control.autoPosition == 1) {
            deliverToFloorPose = new Pose2d(-34.5, 33, Math.toRadians(180));
            Actions.runBlocking(
                    //drive.actionBuilder(drive.  new Pose2d(50+control.rangeError, 36+control.yawError, Math.toRadians(180)))
                    drive.actionBuilder(startPose)
                            .splineToLinearHeading(new Pose2d(-35.5, 33, Math.toRadians(270)), Math.toRadians(270))
                            .splineToLinearHeading(new Pose2d(-27, 33, Math.toRadians(180)), Math.toRadians(0))
