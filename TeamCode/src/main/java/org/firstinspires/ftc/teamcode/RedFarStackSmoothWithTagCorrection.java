...
@Autonomous(name="Red Far Stack SMOOTH with Tag Correction", preselectTeleOp="ManualWithUniversalClass")
public class RedFarStackSmoothWithTagCorrection extends LinearOpMode {
    ...
    public void RedBoardDelivery() {
        ...
        if (control.autoPosition == 1) {
            deliverToBoardPose = new Pose2d(47.5,-27,Math.toRadians(180));
            Actions.runBlocking(
        ...
        //***POSITION 3***
            ...
            deliverToBoardPose = new Pose2d(47.5,-34,Math.toRadians(180));
            Actions.runBlocking(
                    drive.actionBuilder(drive.pose)
                            .setTangent(0)
                            .splineToLinearHeading(new Pose2d(-30, -7, Math.toRadians(180)), Math.toRadians(0))
